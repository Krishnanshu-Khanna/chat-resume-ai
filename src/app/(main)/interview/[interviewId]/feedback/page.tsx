  ...
  {feedbackList.length === 0 ? (
    <Card className="mx-auto max-w-lg shadow-lg">
      ...
      <CardContent className="text-center">
        <p className="mb-6 text-gray-600 text-sm">
          No feedback has been generated for this interview. It could be due to an incomplete interview or system issue.
        </p>
        <Button 
          variant="outline" 
    ...
    <>
      <div className="mx-auto mb-8 max-w-3xl">
        <Card className="shadow-md">
          <CardHeader className="flex flex-row items-center gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-purple-600">Great Job!</h2>
              <p className="text-gray-600 text-sm">You’ve completed your mock interview.</p>
            </div>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <p className={`text-2xl font-bold ${getRatingColor({ rating: averageRating })}`}>
      ...
      <div className="mx-auto max-w-3xl space-y-6">
        <h3 className="text-lg font-semibold text-gray-800">Detailed Interview Feedback</h3>
        <p className="text-sm text-gray-500">
          Review each question&apos;s performance and get insights for improvement.
        </p>

        {feedbackList.map((item, index) => (
          <Collapsible key={index} className="overflow-hidden rounded-lg border shadow-sm">
            <CollapsibleTrigger className="w-full">
              <div className="flex items-center justify-between bg-gray-100 p-4 transition-all hover:bg-gray-200">
            ...
            <CollapsibleContent className="bg-white p-5">
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  <h4 className="mb-2 font-medium text-gray-700">Your Answer</h4>
                  <p className="rounded-lg border border-red-200 bg-red-50 p-3 text-sm text-red-900">
                    {item.userAns || "No answer provided"}
                  </p>
                </div>
                <div>
                  <h4 className="mb-2 font-medium text-gray-700">Correct Answer</h4>
              ...
              <div className="mt-4">
                <h4 className="mb-2 font-medium text-gray-700">Feedback</h4>
                <p className="rounded-lg border border-blue-200 bg-blue-50 p-3 text-sm text-blue-900">
                  {item.feedback}
                </p>
              </div>
              <div className="mt-4 text-right">
                <span className={`font-semibold ${getRatingColor({ rating: item.rating })}`}>
